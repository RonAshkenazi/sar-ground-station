---
name: babysit
description: Watch a pull request until it is ready to merge. Use when asked to monitor a PR, babysit checks, or keep watching until all review comments and CI checks are resolved.
---
...
6. Resolve stale review threads only after verifying the code now addresses the comment.
...
- Report concrete evidence: latest commit SHA, check names and results, unresolved thread count, tests run.
