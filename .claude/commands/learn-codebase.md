---
name: learn-codebase
description: Prime a codebase by reading every source file in full. Use when starting work on a new or unfamiliar project, or when asked to "learn the codebase", "read the codebase", "prime", or "get up to speed".
---
