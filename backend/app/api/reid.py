...
def run_reid_endpoint(
    ...
    background_tasks.add_task(_run_reid_task, execution_id, session_id, enriched_csv_path)
    return {"execution_id": execution_id, "status": "pending"}


def _run_reid_task(execution_id: str, session_id: str, enriched_csv_path: Path) -> None:
    ...
    try:
        ...
        result = run_reid(enriched_csv_path=enriched_csv_path, protocol=protocol)
